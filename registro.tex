...
\operacion{campos}{in r: dicc(campo\, dato)}{res : itConj(campo)}
 ...
 {O($calc$)} %\[$\Theta(\sum\_{c' in  c}equal(c,c')), donde $c$ $=$ claves($d$)\]%
...
\operacion{copiarCampos}{in/out  r\_1: dicc(campo\, dato), in  cc: conj(campo), in r2: reg}{}
{$r1 \igobs r1\_0 \land  cc \in  campos(r2) $}
...
\operacion{combinarTodos}{in c: campo\, in r1:dicc(campo dato), in cr: conj(dicc(campo\,dato))}
...
\algoritmo{campos}{in r: dicc(campo\, dato)}{res:conj(campo)}{
