...
\tupla{
		...
		IndiceS:\tupla{CampoI: campo, EnUso: bool, Indice: DiccTrie(\mbox{string, Conj(ItConj(Registro)))}},
		IndiceN:\tupla{CampoI: campo, EnUso: bool, Indice: DiccNat(\mbox{nat, Conj(ItConj(Registro)))}},
		\#Accesos: Nat
  		}
}
}
...
\algoritmo{borrarRegistro}{in crit: registro,in t: tab}{}{
	\State	c $\larr$ Siguiente(Campos(crit))	\complejidad{$\theta$(1)} %chequear
